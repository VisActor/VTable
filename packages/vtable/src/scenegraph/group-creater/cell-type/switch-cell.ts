import { Switch } from '@visactor/vrender-components';
...
import type { SwitchAttributes } from '@visactor/vrender-components';
...
function createSwitch(
  ...
  const spaceBetweenTextAndCircle = getProp('spaceBetweenTextAndCircle', style, col, row, table) ?? 6;
  const circleRadius = getProp('circleRadius', style, col, row, table) ?? 8;
