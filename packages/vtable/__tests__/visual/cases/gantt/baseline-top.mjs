/**
 * BugServer case IDs: 69a681915bd8c7005e123d92
 * 验证目的：Gantt 任务条上方显示计划基线，三级时间轴与进度同时绘制。
  ...
  mount(container) {
    ...
    return new window.VTableGantt.Gantt(container, {
      ...
      taskBar: {
        ...
        baselinePosition: 'top', baselineStyle: { width: 15, barColor: 'gray', cornerRadius: 5 }
      },
