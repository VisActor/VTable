/**
 * BugServer case IDs: 665ecceafaec2700ad749556
 * 验证目的：验证 cross 选择高亮、自定义选择主题、表头单格选择、转置布局在表体和表头点击后的状态与截图。
...
export default {
  mount(container) {
    ...
    return new window.VTable.ListTable(container, {
      ...
      transpose: true,
      theme: { selectionStyle: { cellBgColor: 'rgba(130, 178, 245, 0.2)', cellBorderLineWidth: 2, cellBorderColor: '#0000ff', inlineRowBgColor: '#ffe599', inlineColumnBgColor: '#d9e8ff' } },
      select: { highlightMode: 'cross', headerSelectMode: 'cell' },
  ...
  async verify(page) {
    ...
    }, { expectedScope: 'cross', expectedRow: 0, headerCell: true });
  }
};
