/**
 * BugServer case IDs: 6aaba8136d3a95005dc7fa6e
 * 验证目的：横向滚动到 middle 时，冻结列阴影仅在存在溢出的一侧显示。
...
export default {
  ...
  async exercise(page) {
    ...
    await page.evaluate(() => window.__visualTable.setScrollLeft(280));
  ...
  async verify(page) {
    ...
    }, { left: true, right: true, position: 'middle' });
  }
};
