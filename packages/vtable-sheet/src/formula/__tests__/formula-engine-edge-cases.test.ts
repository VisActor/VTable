...
describe('FormulaEngine.adjustFormulaReferences - Edge Cases', () => {
  ...
  describe('Boundary Conditions', () => {
    ...
    test('should handle insert at last row', () => {
      ...
      engine.adjustFormulaReferences('Sheet1', 'insert', 'row', 999, 1);
  ...
  describe('Multiple Operations', () => {
    test('should handle multiple inserts', () => {
      ...
      engine.adjustFormulaReferences('Sheet1', 'insert', 'row', 0, 1); // Insert at row 0
      engine.adjustFormulaReferences('Sheet1', 'insert', 'row', 1, 1); // Insert at row 1
    ...
    test('should handle multiple deletes', () => {
      ...
      engine.adjustFormulaReferences('Sheet1', 'delete', 'row', 1, 1); // Delete row 1
  ...
  describe('Large Count Operations', () => {
    test('should handle insert with large count', () => {
      ...
      engine.adjustFormulaReferences('Sheet1', 'insert', 'row', 5, 10); // Insert 10 rows
    ...
    test('should handle delete with large count', () => {
      ...
      engine.adjustFormulaReferences('Sheet1', 'delete', 'row', 5, 10); // Delete 10 rows
