...
const sheetOption = {
  ...
  sheets: [
    ...
    },
    {
      ...
      data: [
        ...
        ['办公用品', '消费者', '一级', '何芯', 'SanDisk 羊皮纸, 多色', '纸张', 'CN-2018-1150523', '7', '3,798.48', '0'],
        [
          '办公用品',
          '消费者',
          '二级',
        ...
        ['办公用品', '消费者', '二级', '唐安', 'Novimex 运输标签, 白色', '标签', 'CN-2016-4217149', '7', '246.96', '0'],
        [
          '办公用品',
          '消费者',
          '一级办公123123123213123123123123213123213213(标准级)',
        ...
        ['技术', '公司', '二级', '宋良', 'Brother 传真复印机, 红色', '复印机', 'CN-2018-1599696', '7', '1,732.50', '0'],
        [
          '家具',
          '消费者',
          '一级办公123123123213123123123123213123213213(标准级)',
        ...
        ['技术', '公司', '一级', '白婵', '夏普 无线传真机, 彩色', '复印机', 'CN-2016-5908054', '7', '-1,202.04', '0.4'],
        [
          '办公用品',
          '消费者',
          '一级办公123123123213123123123123213123213213(标准级)',
  ...
  mainMenu: {
    ...
    items: [
      {
        name: '导入',
        menuKey: VTableSheet.TYPES.MainMenuItemKey.IMPORT,
...
debugger;
const sheetInstance = new VTableSheet.VTableSheet(container, sheetOption);
