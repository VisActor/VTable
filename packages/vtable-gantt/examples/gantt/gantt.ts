...
export function createTable() {
  ...
  ganttInstance.taskListTableInstance?.on('mouseenter_cell', e => {
    console.log('mouseenter_cell ', e);
  });
  ganttInstance.taskListTableInstance?.on('mouseleave_cell', e => {
    console.log('mouseleave_cell ', e);
  });
