...
root.render(
  <ReactVTable.ListTable 
    ...
    height={'500px'}
  >
    <ReactVTable.ListColumn field={'bloggerId'} caption={'bloggerId'} />
    ...
    />
    <ReactVTable.ListColumn field={'fansCount'} caption={'fansCount'} />
    <ReactVTable.ListColumn field={'worksCount'} caption={'worksCount'} />
    <ReactVTable.ListColumn field={'viewCount'} caption={'viewCount'} />
  </ReactVTable.ListTable>
);
