...
| ctrl/cmd+z | Undo. Requires `HistoryPlugin` (or VTable-Sheet workbook history). |
| ctrl/cmd+shift+z / ctrl/cmd+y | Redo. Requires `HistoryPlugin` (or VTable-Sheet workbook history). |
