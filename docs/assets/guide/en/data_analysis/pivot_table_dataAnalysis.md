...
dataConfig: {
      totals: {
        row: {
          ...
          grandTotalDimensions: ['city'], // Group the grand total by city and append an overall subtotal
