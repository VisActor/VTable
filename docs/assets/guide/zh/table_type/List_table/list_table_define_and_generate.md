...
*   `columns`：表格列的配置，每一列需要分别设置配置项，包括列类型、宽度、标题等。支持的列类型有：'text'、'link'、'image'、'video'、'audio'、'sparkline'、'progressbar'、'chart'、'checkbox'、'radio'、'switch'、'button'。每种列类型的配置项略有差别，请根据所需类型灵活添加特有配置，可参考[文档](../../guide/cell_type/cellType)。
