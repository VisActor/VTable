...
将 vchart 图表库结合渲染到表格中，丰富可视化展示形式，提升多图表渲染性能。该示例引用了 vchart 的线柱饼面图，具体可参考：https://visactor.io/vchart/demo/progress/linear-progress-with-target-value
