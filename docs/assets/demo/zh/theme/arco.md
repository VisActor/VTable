...
对齐 arco-design 的主题样式。具体配置内容可查看：https://github.com/VisActor/VTable/blob/develop/packages/vtable/src/themes/ARCO.ts，注意改该主题有阴影占位，frameStyle中配置了shadowBlur的宽度。
