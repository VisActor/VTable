...
категория: примеры
группа: edit
заголовок: custom date editor
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/preview/custom-date-editor.png
ссылка: edit/edit_cell
опция: ListTable-columns-text#editor
---
