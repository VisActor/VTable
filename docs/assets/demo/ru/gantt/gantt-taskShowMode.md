...
категория: примеры
группа: gantt
заголовок: Gantt Chart Sub-task Layout Mode
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/gantt/gantt-taskShowMode.gif
...
- `Sub_Tasks_Compact`: The parent task node is omitted and not displayed, and all subtasks will be laid out according to the date порядок attribute, ensuring a compact display without node overlap.
