...
категория: примеры
группа: gantt
заголовок: Gantt Task Hour Unit
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/gantt/gantt-hour.png
ссылка: gantt/introduction
опция: Gantt#timelineHeader.scales
---

# Gantt Task Hour Unit

Support configuration of time scale unit('day' | 'week' | 'month' | 'quarter' | 'year' | 'hour' | 'minute' | 'second')
