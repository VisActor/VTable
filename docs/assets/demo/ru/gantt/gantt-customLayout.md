...
категория: примеры
группа: gantt
заголовок: Custom Rendering Usage of Gantt Chart
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/gantt/gantt-customLayout-preview.png
ссылка: gantt/gantt_customLayout
опция: Gantt#taskBar
---

# Custom Rendering Usage of Gantt Chart

This example demonstrates how to customize the rendering of Gantt chart task bars and date headers. The custom rendering of the left task information table is implemented in the customLayout defined in columns. Refer to [tutorial](../../опция/ListTable-columns-text#customLayout).
