...
категория: примеры
группа: gantt
заголовок: Gantt Chart Interaction - Drag Table Width
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/gantt/gantt-interaction-drag-table-width-preview.gif
ссылка: gantt/introduction
опция: Gantt#frame.verticalSplitLineMoveable
---
