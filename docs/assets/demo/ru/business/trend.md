...
категория: примеры
группа: Business
заголовок: Trend table
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/preview/trend.png
порядок: 9-4
---
...
const option = {
  rowTree: [
    ...
    {
      dimensionKey: 'order_data',
      value: 'Прибыль Amount'
    },
    {
      dimensionKey: 'order_data',
      value: 'Продажи Amount'
    },
    {
      dimensionKey: 'order_data',
  ...
  records: [
    ...
    {
      order_data: 'Прибыль Amount',
      time: '2020',
      data: 102504,
      ratio: 0.11
    },
    {
      order_data: 'Продажи Amount',
      time: '2020',
      data: 202504,
      ratio: 0.11
    },
...
[performance optimization](ссылка)
