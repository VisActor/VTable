...
категория: примеры
группа: Business
заголовок: China’s population pyramid in 2023
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/preview/population-pyramid.png
---
...
- `заголовок` defines the заголовок
