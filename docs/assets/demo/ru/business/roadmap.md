...
группа: Business
заголовок: Roadmap
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/Vтаблица/preview/roadmap.png
порядок: 9-6
---

# Roadmap

This пример shows the main R & D roadmap that follows Vтаблица
...
// 注册里程碑的иконка 小旗帜
  Vтаблица.регистрация.иконка('milestone', {
    имя: 'milestone',
    тип: 'svg',
    ширина: 50,
    высота: 50,
  ...
  Vтаблица.регистрация.иконка('animation', {
    ...
    interactive: false,
    svg: '<svg t="1688180606131" class="иконка" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2767" ширина="200" высота="200"><path d="M156 64v896l356-280 356 280V64H156z m511.8 556.4L512 538.5l-155.7 81.9L386 447 260 324.2l174.1-25.3L512 141.1l77.9 157.8L764 324.2 638 447l29.8 173.4z" fill="#1cdb11" p-id="2768"></path></svg>'
  });
  // 注册基础功能图标
  Vтаблица.регистрация.иконка('функция', {
    positionType: Vтаблица.TYPES.иконкаPosition.contentLeft,
    имя: 'функция',
    тип: 'svg',
    ширина: 20,
  ...
  Vтаблица.регистрация.иконка('arrow', {
    ...
    marginRight: 90,
    interactive: false,
    svg: '<svg xmlns="http://www.w3.org/2000/svg" ширина="67" высота="11" viewBox="0 0 67 11" fill="никто"><path d="M60 0.5H2L7 5L2 10H60L65.5 5L60 0.5Z" fill="#E13B9F" strхорошоe="#E13B9F"/></svg>'
  });

  const records = [
    {
      month: 'JUL',
      базовый: 'пользовательский макет'
      // Animation: ''
      // компонент: 'animation  1'
      // Visualize: ''
    },
    {
      month: 'AUG',
      ...
      базовый2: 'Row Frozen',
      // Animation: ''
      компонент: 'Access Common Visual компонент',
    ...
    },
    {
      ...
      базовый: 'флажок тип',
      базовый2: 'Row Frozen',
      Animation: 'сортировка Animation',
      компонент: 'Access Common Visual компонент',
      Visualize: 'сводный график'
    },
    {
      month: 'OCT',
      базовый: 'Download',
      базовый2: 'сводный Analysis',
      Animation: 'развернуть Animation',
      компонент: 'Access Common Visual компонент',
      Visualize: 'сводный график'
    },
    {
      ...
      базовый: 'Ediтаблица',
      базовый2: 'сводный Analysis',
      Animation: 'перетаскивание Animation',
      // компонент: '',
      Visualize: 'Other таблица тип'
    },
    {
      month: 'DEC',
      базовый: 'Ediтаблица',
  ...
  const option = {
        ...
        columns: [
          //如果只有一行 可直接拿到外层columns中
          {
            ...
            иконка(args) {
              ...
              const style = таблица.getCellStyle(col, row);
              const cellValue = таблица.getCellValue(col, row);
              if (!cellValue) {
                возврат '';
              }
              const cellMergeRectW = таблица.getMergeCellRect(col, row).ширина;
              let textширина = 0;
              if (cellValue) {
                textширина = таблица.measureText(cellValue, {
                  fontFamily: style.fontFamily,
                  fontSize: style.fontSize
                }).ширина;
              }
              const bgширина = Math.min(cellMergeRectW, Math.max(cellMergeRectW * 0.8, textширина + 50));
              возврат [
                'функция',
                {
                  имя: 'arrow',
                  ...
                  высота: 50,
                  positionType: Vтаблица.TYPES.иконкаPosition.absoluteRight,
                  marginRight: (cellMergeRectW - bgширина) / 2,
                  interactive: false,
    svg: '<svg xmlns="http://www.w3.org/2000/svg" ширина="67" высота="11" viewBox="0 0 67 11" fill="никто"><path d="M60 0.5H2L7 5L2 10H60L65.5 5L60 0.5Z" fill="#E13B9F" strхорошоe="#E13B9F"/></svg>'
                }
              ];
        ...
        иконка(args) {
          ...
          возврат [
            'visualize',
            {
              ...
              marginRight: (cellMergeRectW - bgширина) / 2,
              interactive: false,
    svg: '<svg xmlns="http://www.w3.org/2000/svg" ширина="74" высота="11" viewBox="0 0 74 11" fill="никто"><path d="M67 0.5H2L7 5L2 10H67L72.5 5L67 0.5Z" fill="#2BC1F0" strхорошоe="#2BC1F0"/></svg>'
            }
          ];
        },
        headerиконка: ['milestone']
        ...
        иконка(args) {
          ...
          возврат [
            'animation',
            {
              ...
              marginRight: (cellMergeRectW - bgширина) / 2,
              interactive: false,
    svg: '<svg xmlns="http://www.w3.org/2000/svg" ширина="74" высота="11" viewBox="0 0 74 11" fill="никто"><path d="M67 0.5H2L7 5L2 10H67L72.5 5L67 0.5Z" fill="#A23BE1" strхорошоe="#A23BE1"/></svg>'
            }
          ];
        },
        headerиконка: ['milestone']
        ...
        иконка(args) {
          ...
          возврат [
            'компонент',
            {
              ...
              marginRight: (cellMergeRectW - bgширина) / 2,
              interactive: false,
    svg: '<svg xmlns="http://www.w3.org/2000/svg" ширина="74" высота="11" viewBox="0 0 74 11" fill="никто"><path d="M67 0.5H2L7 5L2 10H67L72.5 5L67 0.5Z" fill="#F0B92B" strхорошоe="#F0B92B"/></svg>'
            }
          ];
        },
        headerиконка: ['milestone']
    ...
    transpose: true,
    defaultRowвысота: 30,
    defaultHeaderColширина: 200,
    defaultColширина: 180,
    высотаMode: 'автовысота',
    columnResizeMode: 'никто'
  };
