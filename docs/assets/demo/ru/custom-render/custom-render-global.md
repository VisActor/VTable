...
категория: примеры
группа: Custom
заголовок: Global cell custom content
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/preview/custom-render-global.png
порядок: 7-3
ссылка: custom_define/custom_render
опция: ListTable#customRender.elements
---
