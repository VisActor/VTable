...
Using JSX to describe custom cell content can more clearly express the hierarchical relationship between graphics elements and increase maintainability.
