...
категория: примеры
группа: Cell Type
заголовок: Progressba Type
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/preview/progressbar.png
порядок: 2-2
ссылка: cell_type/progressbar
опция: ListTable-columns-progressbar#cellType
---
...
headerType: 'text' | 'ссылка' | 'image' | 'video';
