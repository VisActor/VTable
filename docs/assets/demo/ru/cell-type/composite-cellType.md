...
категория: примеры
группа: Cell Type
заголовок: Custom function specifies cell type
обложка: https://lf9-dp-fe-cms-tos.byteorg.com/obj/bit-cloud/VTable/preview/cellType-function.png
Order: 2-1
ссылка: cell_type/cellType
опция: ListTable-columns-function#cellType
---
