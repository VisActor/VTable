...
Inula.render(
  <InulaVTable.ListTable 
    ...
    height={'500px'}
  >
    <InulaVTable.ListColumn field={'bloggerId'} caption={'bloggerId'} />
    ...
    />
    <InulaVTable.ListColumn field={'fansCount'} caption={'fansCount'} />
    <InulaVTable.ListColumn field={'worksCount'} caption={'worksCount'} />
    <InulaVTable.ListColumn field={'viewCount'} caption={'viewCount'} />
  </InulaVTable.ListTable>,
  root
);
